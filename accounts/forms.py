...
class UserCreation(UserCreationForm):
        ...
        numero_telephone= forms.CharField(label="", max_length=9,widget=forms.TextInput(attrs={'class': 'form-control', 'name': 'Téléphone','placeholder':'Numero de téléphone','required':'True','autofocus':'True'}))
